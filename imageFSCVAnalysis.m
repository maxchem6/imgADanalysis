function []=imageFSCVAnalysis()
%imageFSCVAnalysis uses SSIM image analysis for adenosine transient detection.
%Code was written by Pumidech Puthongkham, pp6wr@virginia.edu

clc; clear; close all; warning('off','all') %clear and suppress warnings
disp('============================================')
...
for i=1:totalfile
    ...
    currMinBound=max([3*currNoise 0.45]);
